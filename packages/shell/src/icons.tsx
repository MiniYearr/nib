...
/**
 * Lucide-style inline SVG icons (MIT). Inlined rather than loaded from a CDN
 * because the app's CSP forbids external requests. Each entry is the inner
 * markup of a 24×24 stroke icon; the wrapper sets the shared stroke styling.
 */
const PATHS: Record<string, string> = {
  ...
  puzzle:
    '<path d="M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 19.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0"/><path d="M4.39 15.39a1 1 0 0 1-.474 1.68 2.5 2.5 0 1 0 3.015 3.014 1 1 0 0 1 1.68.474l1.682-1.683a2.414 2.414 0 0 0 0-3.414L9.61 13.61"/>',
  ...
  quote:
    '<path d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v1a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"/><path d="M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v1a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"/>',
...
export function Icon({ name, size = 16, style, className, strokeWidth = 1.9 }: IconProps) {
